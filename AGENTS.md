...
This file captures the repository conventions for `guzzlehttp/command`. The
organization-wide
...
- `2.0` is the unreleased next major version and `1.5` is the current stable
...
[security policy](https://github.com/guzzle/command/security/policy) instead.
